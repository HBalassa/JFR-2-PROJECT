/******************************************************************************
 * A file GITHUB-rol letoltve *
 * Created:		26-09-2024 12h
 * Author :		Balassa Hodi
 * File name:	gyak04_09.26
******************************************************************************/
 /******************************************************************************
* Include files
******************************************************************************/
...
* Description:      kulso megszakitas inicializalasa
* Input:
* Output:
* Notes:
******************************************************************************/
...
* Description:      karakter kuldese uart-on
* Input:
* Output:
* Notes:			from AT90CAN32.pdf datasheet p.184
******************************************************************************/
void uart0_send_char(char data) {
...
/******************************************************************************
* Function:         void uart0_write_string(char *string)
* Description:      karaktersorozat kiírása az UART-ra
* Input:
* Output:
* Notes:
******************************************************************************/
...
* Description:      analog to digital converter init
* Input:
* Output:
* Notes:
******************************************************************************/
...
int main(void)
{
    ...
    while (1)
    {
		...
		if(task_100ms == TRUE)
		{
			ADCSRA |= (1<<ADSC); // Ez inditja mindig a konverziot
			PORTA = ad_result;
			PORTF ^= 0X02;
			...
			uart0_write_string(write_string);
			uart0_write_string("\r\n");
