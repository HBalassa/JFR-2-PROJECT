...
* Description:     kitorli az lcd kepen levo karaktereket
* Input:
* Output:
* Notes:
******************************************************************************/
...
* Description:     kurzor poziciojat adott helyre rakja
* Input:
* Output:
* Notes:			ST7066U p.20
******************************************************************************/
...
* Description:     karaktersorozat kiirasa az lcd kijelzore
* Input:
* Output:
* Notes:			
******************************************************************************/
void lcd_write_string(char* string) {
	...
	// *p: pointer altal mutatott memoriateruleten levo ertek
	// *p++: az erteket lekerjuk, majd noveljuk a memoriacimet
}